       ...
       return  db.delete(PatientTable.TABLE_NAME,PatientTable.NAME + "=" + id ,null);
        ...
        public String getPatient() {
            ...
            for (x.moveToFirst(); !x.isAfterLast(); x.moveToNext()) {
                ...
                result = result + x.getString(tid) + "\t: " + x.getString(tname) + "\nDate of birth: " + x.getString(tage) + "\ndisease: " + x.getString(tdisease) + "\nprescription: " + x.getString(tprescription) +
                        "\ndrugs given: " + x.getString(tdrug) + "\nreturn on: " + x.getString(treturndate) + "\ncomment " + x.getString(tremarks) + "\n";
